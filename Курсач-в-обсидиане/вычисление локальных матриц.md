...
$$\Large\int_{r_p}^{r_p+h_r}{\left(\frac{dR_1}{dr}\right)^2r\space dr} = \frac{r_p}{h_r}+\frac{1}{2}, $$
$$\Large\int_{r_p}^{r_p+h_r}{\left(\frac{dR_2}{dr}\right)^2r\space dr} = \int_{r_p}^{r_p+h_r}{\left(\frac{dR_1}{dr}\right)^2r\space dr} = \frac{r_p}{h_r}+\frac{1}{2}, $$
$$\large\int_{r_p}^{r_p + h_r} {\frac{dR_1}{dr}\frac{dR_2}{dr}r\space dr} = -\frac{r_p}{h_r}-\frac{1}{2},$$
$$\large\int_{r_p}^{r_p+h_r}{\frac{1}{r}R_1^2\space dr} = \left(\frac{r_p^2}{h_r^2} + \frac{2r_p}{h_r} + 1\right)ln\left(\frac{r_p+h_r}{r_p} \right) - \frac{r_p}{h_r} - \frac{3}{2},$$
$$\large\int_{r_p}^{r_p+h_r}{\frac{1}{r}R_2^2\space dr} = -\left(\frac{r_p}{h_r}\right)ln\left(\frac{r_p+h_r}{r_p} \right)  + 1,$$
$$\large\int_{r_p}^{r_p+h_r} {\frac{1}{r}R_1 R_2\space dr} = -ln\left(\frac{r_p+h_r}{r_p}\right)\left(\frac{r_p}{h_r}+\frac{r_p^2}{h_r^2}\right) + \frac{r_p}{h_r} + \frac{1}{2},$$
$$\large {\int_{\phi_s}^{\phi_s+h_\phi} {\Phi_1^2\space d\phi} } = {\frac{h_\phi}{3}},$$
$$\large {\int_{\phi_s}^{\phi_s+h_\phi} {\Phi_2^2\space d\phi} } = {\int_{\phi_s}^{\phi_s+h_\phi} {\Phi_1^2\space d\phi} } = {\frac{h_\phi}{3}},$$
$$\Large\int_{\phi_s}^{\phi_s+h_\phi} {\Phi_1\Phi_2\space d\phi} = \frac{h_\phi}{6}$$
$$\large\int_{\phi_s}^{\phi_s + h_\phi} {\left(\frac{d\Phi_1}{d\phi}\right)^2\space d\phi} = \frac{1}{h_\phi}$$
$$\large\int_{\phi_s}^{\phi_s + h_\phi} {\left(\frac{d\Phi_2}{d\phi}\right)^2\space d\phi} = \int_{\phi_s}^{\phi_s + h_\phi} {\left(\frac{d\Phi_1}{d\phi}\right)^2\space d\phi} = \frac{1}{h_\phi}$$
$$\Large \int_{\phi_s}^{\phi_s+h_\phi} {\frac{d\Phi_1}{d\phi} \frac{d\Phi_2}{d\phi} \space d\phi} = - \int_{\phi_s}^{\phi_s + h_\phi} {\left(\frac{d\Phi_1}{d\phi}\right)^2\space d\phi} = -\frac{1}{h_\phi}$$
